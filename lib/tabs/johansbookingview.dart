...
class JohansBookingView extends StatefulWidget {
  const JohansBookingView({Key? key}) : super(key: key);

  @override
  State<JohansBookingView> createState() => _JohansBookingViewState();
}

//Widget to view and un-book timeslots.
class _JohansBookingViewState extends State<JohansBookingView> {
  @override
